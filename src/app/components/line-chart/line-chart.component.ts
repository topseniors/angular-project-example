...
@Component({
  ...
  template: `
    <div class="line-chart">
      <svg width="100%" height="100%" viewBox="0 0 700 340"></svg>
    </div>
  `,
...
export class LineChartComponent implements OnInit {
  ...
  private initSvg() {
    this.width = parseInt(d3.select("svg").style("width"));
    this.height = parseInt(d3.select("svg").style("height"));
  ...
  private resize() {
      // update width
      this.width = parseInt(d3.select('svg').style('width'), 10);
